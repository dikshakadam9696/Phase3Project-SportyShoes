...
<!-- <body>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3 pl-3">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <span class="list-group-item"><strong>Email:</strong> CustomerSupport@sportyShoes.com</span>              
    ...
    <div class="copyright">Copyright © 2021 SportyShoes Developer:<span class="text-info"> Diksha Kadam</span></div>  
  
              <span class="list-group-item"><strong>Email:</strong> dikshakadam9696@gmail.com</span>              
    ...
    <div class="copyright">Copyright © 2021 SportyShoes Developer:<span class="text-info">Diksha Kadam</span>
  </div>
  </div> -->
  </body>
</html>